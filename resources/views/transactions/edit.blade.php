                        ...
                        <div class="card mb-5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="material" class="form-control" value="{{ $transaction->material }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Deadline</label>
                                    <input type="date" name="deadline" class="form-control"
                                        value="{{ $transaction->deadline?->format('Y-m-d') }}">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="remarks" class="form-control" rows="2">{{ $transaction->remarks }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <button type="button" id="btn_submit_order" class="btn btn-primary w-100">
                                    <i class="fa fa-save me-1"></i> Update Job Order
                                </button>
                            </div>
                        </div>
                    </div>
...
(function () {
    ...
    $(document).ready(function () {
        ...
        // Load existing items grouped by group_id
        ...
        $('#btn_submit_order').on('click', function () {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    $btn.prop('disabled', false).html('<i class="fa fa-save me-1"></i> Update Job Order');
                },
            });
        });
